	...
	DateTimePicker.prototype = {
		...
		enquire.register("screen and (max-width: 999px)", {
      	...
      	// Load in content via AJAX (just the once)
		    ...
		    match : function() {
			// $('.mainwrap').addClass('hidemain-scroll');
		     },
		      unmatch : function() {
		    }
		});
		...
		enquire.register("screen and (max-width: 999px)", {
      	...
      	// Load in content via AJAX (just the once)
		    ...
		    match : function() {
				// $('.mainwrap').removeClass('hidemain-scroll');
		     },
		      unmatch : function() {
		    }
		});
		...
		_addEventHandlersForPicker: function()
		{
			...
			$(".dtpicker-cont *").click(function(e)//j2
			{
				e.stopPropagation();
			});
			...
			$(oDTP.element).find('.dtpicker-close').click(function(e)
			{
		      ...
		      $('body').removeClass('hidebody-scroll');//j2
			});
