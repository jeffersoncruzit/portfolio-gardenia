...
$.fn.notification = function ( options ) {
  ...
  function popup_activate() {
    target.find('.popup-container, .popup-main, .popup-wrap, .dynamic-popup, .btn-popup_close').show();
    $('body').addClass('stop-scroll');
    // target.find('.popup-container').addClass('dropDownMenu');
  }

  function popup_deactivate() {
    target.find('.popup-container, .popup-main, .popup-wrap, .dynamic-popup, .btn-popup_close').hide();
  ...
  target.find('.btn-popup_close, .popup-wrap, .btn_popup_close').click(function(){
    popup_deactivate();
  });
